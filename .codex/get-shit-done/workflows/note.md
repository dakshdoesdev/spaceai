...
- **Global scope**: `/home/dux/Work/tries/SpaceAI/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dux/Work/tries/SpaceAI/.codex/notes/`)
...
2. Glob `/home/dux/Work/tries/SpaceAI/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/dux/Work/tries/SpaceAI/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dux/Work/tries/SpaceAI/.codex/notes/` — works in any directory
