...
<required_reading>
@/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/references/ai-frameworks.md
@/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/dux/Work/tries/SpaceAI/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/dux/Work/tries/SpaceAI/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/dux/Work/tries/SpaceAI/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/dux/Work/tries/SpaceAI/.codex/agents/gsd-eval-planner.md for instructions.
