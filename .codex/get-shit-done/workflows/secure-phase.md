...
```
Task(
  prompt="Read /home/dux/Work/tries/SpaceAI/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/templates/SECURITY.md`
