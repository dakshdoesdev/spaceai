...
```bash
INIT=$(node "/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/templates/spec.md.
