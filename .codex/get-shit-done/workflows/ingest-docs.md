...
```bash
INIT=$(node "/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
