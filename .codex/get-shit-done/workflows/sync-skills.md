...
INSTALL_JS_GLOBAL="/home/dux/Work/tries/SpaceAI/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/dux/Work/tries/SpaceAI/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
